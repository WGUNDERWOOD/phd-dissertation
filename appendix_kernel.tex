...
\TODO{leave these technical strong approx results here}
...
\begin{proof}[Lemma~\ref{lem:kernel_bias}]
...
\begin{proof}[Theorem~\ref{thm:uniform_consistency}]
  ...
  This follows from Lemma~\ref{lem:kernel_bias}
  and Lemma~\ref{lem:uniform_concentration}.
\end{proof}
...
\begin{proof}[Theorem~\ref{thm:kernel_minimax}]
  ...
  Firstly Lemma~\ref{lem:kernel_bias} gives
  \begin{align*}
    \sup_{\P \in \cP}
    \sup_{w \in \cW}
    \big|
...
\begin{proof}[Lemma~\ref{lem:studentized_t_statistic}]
  ...
  while Lemma~\ref{lem:kernel_bias} gives
...
\begin{proof}[Lemma~\ref{lem:counterfactual_bias}]
  ...
  Lemma~\ref{lem:kernel_bias} and using H{\"o}lder continuity
