...
In Lemma~\ref{lem:variance_estimator_bounds} we verify that
the estimated covariance function satisfies the same bounds
as those given for the true covariance function
in Lemma~\ref{lem:variance_bounds}.
...
Section~\ref{sec:covariance_estimation} to construct feasible uniform
confidence bands.
...
\begin{proof}[Lemma~\ref{lem:sdp}]
  ...
  \TODO{check this is still the right result}
