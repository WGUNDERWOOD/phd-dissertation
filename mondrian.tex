...
In Section~\ref{sec:overview_proofs} we provide a brief overview of the proofs
...
the reader to Section~\ref{sec:mondrian_proofs} for detailed proofs.
...
Theorem~\ref{thm:clt} gives our first main result; a central
limit theorem.
...
\end{align}
%
In Theorem~\ref{thm:variance_estimation} we show that this
...
As in Section~\ref{sec:debiased}, we take $a_r$ to be a fixed
...
Section~\ref{sec:lifetime_selection}.
...
Figure~\ref{fig:weather_forest} adds more trees to the estimator,
