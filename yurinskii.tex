...
This chapter presents a new Yurinskii coupling which encompasses and
...
this chapter (Section~\ref{sec:kde}), such eigenvalue assumptions can be
...
Section \ref{sec:yurinskii_conclusion} concludes.
