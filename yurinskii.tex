...
Taking $\cH_0$ to be trivial, the first inequality
\eqref{eq:yurinskii_sa_indep_order_2}
in Corollary~\ref{cor:yurinskii_sa_indep} provides an $\ell^p$-norm
approximation
...
estimators, in which we can apply Corollary~\ref{cor:yurinskii_sa_martingale}
directly
due to an intrinsic linear separability property. Secondly, we consider local
polynomial estimators, this time using Proposition~\ref{pro:yurinskii_emp_proc}
due to
...
Lemma \ref{lem:yurinskii_kde_eigenvalue} and its surrounding discussion in
Section~\ref{sec:yurinskii_kde}, and as such, the result of
\citet{li2020uniform} is
