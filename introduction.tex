...
are unreasonable, demonstrably violated, or untestable. Further, the resulting
...
formulated is also correspondingly larger: arbitrary distributions and
...
the name may suggest, the nonparametric approach forgoes the ability to reduce
...
for conducting statistical inference. The importance of inferential techniques
is difficult to overstate, with contemporary nonparametric methods forming a
...
one of the central concepts in classical statistics, and despite the rapid
...
are often absent in the literature.
...
consist of time series, networks, or high-dimensional data, to name just a few.
...
ineffective in the presence of dependent data. As such, the development of new
mathematical results in probability theory and related fields is central to a
comprehensive treatment of nonparametric statistics with complex data.
