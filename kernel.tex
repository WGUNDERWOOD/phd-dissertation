...
\citet{gao2021minimax}, \citet{MatsushitaOtsu2021}, and references therein, for
...
regression using dyadic data \citep{graham2021dyadicregression}.
...
work by \citet{Chernozhukov-Chetverikov-Kato_2017_AoP}. The distributional
...
Calonico-Cattaneo-Farrell_2022_Bernoulli}. Algorithm~\ref{alg:method}
...
\begin{lemma}[Hoeffding-type decomposition for $\hat f_W$]
  ...
  \end{align}
  %
  Further, the stochastic processes $L_n$, $Q_n$ and $E_n$ are all mean-zero
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  %
  \caption{Density $f_W$ and standard deviation
...
robust bias correction \citep{Calonico-Cattaneo-Farrell_2018_JASA,
Calonico-Cattaneo-Farrell_2022_Bernoulli} and Lepskii's method
...
\citet[Section~3.2]{MatsushitaOtsu2021} takes a similar form to our estimator
...
formally in \citet{Calonico-Cattaneo-Farrell_2018_JASA,
Calonico-Cattaneo-Farrell_2022_Bernoulli} for the case of kernel-based density
...
distributions defined in Section~\ref{sec:degeneracy}, along with its three
...
tend to become more connected over time, with edge density, average degree and
clustering coefficient all increasing.
%
\begin{table}[ht]
  \begin{center}
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  %
  \caption{Real and counterfactual density estimates and confidence bands for
...
\citet{graham2021dyadicregression} established pointwise distribution theory
