...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/illustration_total.pdf}
    \caption{
      Total degeneracy, \\
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/illustration_partial.pdf}
    \caption{
      Partial degeneracy, \\
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/illustration_none.pdf}
    \caption{
      No degeneracy, \\
...
we
conclude that the estimator $\hat{f}_W(w)$ achieves the minimax-optimal rate
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/result_total.pdf}
    \caption{
      Total degeneracy, \\
      $\pi = \left( \frac{1}{2}, 0, \frac{1}{2} \right)$
    }
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/result_partial.pdf}
    \caption{
      Partial degeneracy, \\
      $\pi = \left( \frac{1}{4}, 0, \frac{3}{4} \right)$
    }
  ...
  \begin{subfigure}{0.32\textwidth}
    \centering
    \includegraphics[scale=0.52]{graphics/result_none.pdf}
    \caption{
      No degeneracy, \\
      $\pi = \left( \frac{1}{5}, \frac{1}{5}, \frac{3}{5} \right)$
    }
...
+ \sum_{j=i+1}^n k_h(W_{ij}^1,w) \hat\psi(X_j^1) \big)$
and\newline
