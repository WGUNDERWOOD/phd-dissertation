...
assumptions imposed throughout the chapter.
...
Also note that the parameter of interest in this chapter is the Lebesgue density
...
\begin{figure}[ht]
  ...
  \end{subfigure}
  %
  \caption{Typical outcomes for three different values of the parameter $\pi$.}
  %
  \label{fig:results}
  %
\end{figure}
...
Consequently, the strong approximation techniques
presented in this chapter can be appropriately modified
